          ...
          plots: [
            {
              ...
              width: 80,
              height: 60,
              zoning: 'Residential Plot',
              verification: 'TUDA Approved'
            },
            {
              id: 'sg-plot-2',
              number: 'Plot 2',
          ...
          plots: [
            {
              id: 'mf-plot-1',
              number: 'Plot 1',
              dimensions: "60' x 72.6'",
              area: '10 Cents (~4,356 sq ft)',
              price: 'Price on Request',
              status: 'available',
              x: 100,
              y: 80,
              width: 80,
              height: 60,
              zoning: 'Farmland Plot',
              verification: 'Pattadhar Passbook'
            },
            {
              id: 'mf-plot-2',
              number: 'Plot 2',
