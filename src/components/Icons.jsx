...
export const StarIcon = ({ className }) => (
  <svg
    ...
    aria-hidden="true"
  >
    <path d="M12 3.5l2.9 5.88 6.5.94-4.7 4.58 1.1 6.47L12 18.9l-5.8 3.05 1.1-6.47-4.7-4.58 6.5-.94L12 3.5z" />
  </svg>
)
...
export const BedIcon = ({ className }) => (
  ...
  >
    ...
    <path d="M12 10V7a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3" />
  </svg>
)
...
export const BathIcon = ({ className }) => (
  ...
  >
    ...
    <path d="M18 12v5a3 3 0 0 1-3 3H9a3 3 0 0 1-3-3v-5" />
    <path d="M7 8h2" />
  </svg>
)

export const AreaIcon = ({ className }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
...
export const PhoneIcon = ({ className }) => (
  <svg
    ...
    aria-hidden="true"
  >
    <path d="M22 16.5v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3 19.5 19.5 0 0 1-6-6 19.8 19.8 0 0 1-3-8.7A2 2 0 0 1 4.2 2h3a2 2 0 0 1 2 1.7c.1.9.4 1.8.7 2.6a2 2 0 0 1-.5 2.1L8.3 9.7a16 16 0 0 0 6 6l1.3-1.1a2 2 0 0 1 2.1-.5c.8.3 1.7.6 2.6.7a2 2 0 0 1 1.7 2z" />
  </svg>
)
